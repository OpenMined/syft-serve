...
class TestServerStartupError:
    ...
    def test_server_startup_error_with_details(self):
        ...
        error = ServerStartupError(
            "Server 'ml_api' failed to start on port 8001 after 30 seconds"
        )
...
class TestPortConflictError:
    ...
    def test_port_conflict_error_with_range(self):
        ...
        error = PortConflictError(
            "No available ports in range 8000-8010. All ports are in use."
        )
...
class TestProcessTerminationError:
    ...
    def test_process_termination_error_with_reason(self):
        ...
        error = ProcessTerminationError(
            "Process 12345 could not be terminated: Permission denied"
        )

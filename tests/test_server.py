...
class TestServer:
    ...
    def test_server_initialization(self, mock_config):
        ...
        server = Server(handle=mock_handle, endpoints=endpoints, config=mock_config)
    ...
    def test_server_uptime_property(self, mock_config):
        ...
        server = Server(handle=mock_handle, endpoints=[], config=mock_config)
    ...
    def test_server_repr(self, mock_config):
        ...
        server = Server(handle=mock_handle, endpoints=["/hello"], config=mock_config)
    ...
    def test_server_hash(self, mock_config):
        ...
        server2 = Server(handle=mock_handle, endpoints=[], config=mock_config)
...
class TestServerProperties:
    ...
    def test_all_properties_delegate_to_handle(self, mock_config):
        ...
        server = Server(handle=mock_handle, endpoints=["/test"], config=mock_config)
